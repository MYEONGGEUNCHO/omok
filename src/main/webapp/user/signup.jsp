...
<body>
	<main>
		...
		<form action="/omok/createUser" method="post" name="frmMember"
			id="frmMember">
			아이디 <input type="text" id="userId" name="userId"> <input
				type="button" value="중복확인" onclick="btn_duplicate()"> <br>
			<div id="message"></div>
			비밀번호 <input type="password" id="password1" name="pwd"> <br>
			비밀번호 확인 <input type="password" id="password2"> <input
				type="button" value="확인" onclick="btn_correspond()"> <br>
			닉네임 <input type="text" name="nickname" id="nickname"> <br>
			프로필 <select name="profile">
